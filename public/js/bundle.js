...
function doLogin(_x, _x2) {
  return (_doLogin = _doLogin || _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(email, password) {
    var response;
...
if (loginForm) loginForm.addEventListener('submit', function (e) {
  e.preventDefault();
  (0, _login.doLogin)(email.value, pwd.value);
});
if (logoutBtn) logoutBtn.addEventListener('click', _login.doLogout);
